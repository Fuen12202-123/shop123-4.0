...
namespace shop123.Controllers
{
    public class BuyerController : Controller
    {
        ...
        public ActionResult BuyerCenter()
        {
            return View();
        }
        ...
        {
            //找出未成為訂單明細的資料，即購物車內容
            var orderDetails = db.ordersDetail.Where(m => m.orderDetailIsApproved == "否").ToList();
        ...
        public ActionResult AddCar(int skuid)
        {
            ...
            if (currentCar == null)
            {
                ...
                //orderDetail.orderDetailtotalprice = spusku.price * 8;
        ...
        public ActionResult OrderList()
        {
            ...
            //將查詢結果指定給orders
            //var orders = db.orders.Where(m => m.fUserId == fUserId)
            //    .OrderByDescending(m => m.fDate).ToList();
            var orders = db.orders.OrderByDescending(m => m.orderCreateTime).ToList();
